...
# Так же в модуле typing присутствует TypeAlias, позволяющий создавать производные для типов
...
# Можно создавать дженерики. Дженерики -- это концепция программирования,
# позволяющая создавать обобщенные типы данных, которые могут работать с различными
# типами, не привязываясь к конкретному типу данных заранее
