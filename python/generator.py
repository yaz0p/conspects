# Генератор — это функция, которая с выполнит то, что вы описали
# в её теле, но только при вызове метода next 
...
# запустим нашу функцию generator ещё раз и получим новенький объект для работы
